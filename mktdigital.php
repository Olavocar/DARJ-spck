...
<legend>Tipo:</legend>
<p>
<label for=estado>Plano:</label>
<select name=estado>
<option value=sp1>Spotify 1k Plays = R$ 50</option>
<option value=sp2>Spotify 1k Plays + Ouvintes = R$ 70</option>
<option value=sp3>Spotify 1k seguidores = R$ 50</option>
<option value=sp4>Spotify 1k Ouvintes = R$ 30</option>
<option value=yt1>YouTube 1k Views = R$ 100</option>
<option value=yt2>Youtube 1k Inscritos = R$ 300</option>
</select>
</p>
<fieldset>
...
<button type="submit" name="_autoresponse" value="https://https://daarearj.herokuapp.com/pagamento.php">Enviar</button>
</p>
</div>
</fieldset>
</form>
